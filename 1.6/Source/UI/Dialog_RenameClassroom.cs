...
{
    private readonly bool createLetter;
    ...
    public override void DoWindowContents(Rect inRect)
    {
        ...
        if (!(Widgets.ButtonText(
                  new Rect(15f, inRect.height - 35f - 10f,
                      inRect.width - 15f - 15f, 35f), "OK")
              || flag))
        {
            return;
        }
        ...
        if (!acceptanceReport.Accepted)
        {
            ...
            {
                Messages.Message("NameIsInvalid".Translate(),
    ...
    public override void OnRenamed(string name)
    {
        ...
        {
            Find.LetterStack.ReceiveLetter("PE_NewClassroomCreated".Translate(name),
                "PE_NewClassroomCreatedDesc".Translate(),
