...
public class Dialog_EditClassroom : Window
{
    ...
    public override void DoWindowContents(Rect inRect)
    {
        ...
        var colorButtonRect =
            new Rect(inRect.x, inRect.y + 85f, inRect.width, 30f);
        if (Widgets.ButtonText(colorButtonRect, "PE_ChangeColor".Translate()))
        {
            Find.WindowStack.Add(new Window_ColorPicker(newColor,
        ...
        var cancelButtonRect = new Rect(inRect.xMax - 100f, inRect.yMax - 30f, 100f,
            30f);
